...
export default function Pie({filterData,xo,yo,theme}){
        ...
        const color = d3.scaleOrdinal()
            ...
            .range(d3.quantize(t => d3.interpolateSpectral(t * 0.9 + 0.2), data.length).reverse())
        ...
        d3.select("#d3-disc-container").selectAll("svg").remove()
        const svg = d3.select('#d3-disc-container')
          .append('svg')
            .attr("width", width)
            .attr("height", height)
